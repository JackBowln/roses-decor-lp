        ...
        <div class="container mx-auto flex flex-col items-center justify-start relative z-10">
          <div class="flex flex-col items-center justify-center w-full h-[100dvh] relative">
            ...
            >
              <template v-if="mediaType === 'video'">
                <div v-if="mediaSrc.includes('youtube.com')" class="relative w-full h-full pointer-events-none">
                  ...
                  <Motion
                    class="absolute inset-0 bg-black/20 rounded-xl"
                    :initial="{ opacity: 0.5 }"
              ...
              <div class="flex flex-col items-center text-center relative z-10 mt-4 transition-none">
                <p v-if="date" class="text-2xl text-[#E6C35C]" :style="{ transform: `translateX(-${textTranslateX}vw)`, fontFamily: '\'Playfair Display\', serif', fontStyle: 'italic', textShadow: '1px 2px 6px rgba(0,0,0,0.8)' }">
                  {{ date }}
                </p>
                <p v-if="scrollToExpand" class="text-white font-semibold tracking-widest uppercase text-sm mt-3" :style="{ transform: `translateX(${textTranslateX}vw)`, fontFamily: '\'Montserrat\', sans-serif', textShadow: '1px 1px 4px rgba(0,0,0,0.8)' }">
                  {{ scrollToExpand }}
                </p>
              </div>
            </div>
            ...
            >
              <Motion
                as="h2"
                class="text-6xl md:text-7xl lg:text-8xl font-bold text-white transition-none"
              ...
              <Motion
                as="h2"
                class="text-5xl md:text-6xl lg:text-7xl italic text-[#E6C35C] transition-none"
                :style="{ transform: `translateX(${textTranslateX}vw)`, fontFamily: '\'Playfair Display\', serif', textShadow: '2px 4px 12px rgba(0,0,0,0.8)' }"
              >
                {{ restOfTitle }}
              </Motion>
          ...
          <Motion
            as="section"
            class="flex flex-col w-full px-8 py-10 md:px-16 lg:py-20"
            :initial="{ opacity: 0 }"
